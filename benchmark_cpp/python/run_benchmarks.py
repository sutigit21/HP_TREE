...
QUERIES = [
    ...
    ("Q16_topk_groups",       "Top-K Groups"),
    ("Q17_having_clause",     "HAVING Clause"),
    ("Q18_ym_rollup",         "Year/Month Rollup"),
    ("Q19_corr_multi_dim",    "Corr Multi-Dim Part"),
    ("Q20_yoy_semijoin",      "YoY Semi-Join"),
    ("Q21_or_bitmap",         "OR Bitmap"),
    ("Q22_window_top3_month", "Window Top-3/Month"),
    ("Q23_cte_correlated",    "CTE Correlated"),
    ("Q24_yoy_selfjoin",      "YoY Self-Join"),
    ("Q25_dense_hyperbox",    "Dense Hyperbox 4D"),
]
